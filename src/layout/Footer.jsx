export default function Footer() {
  return (
    <div className="w-screen h-[84rem] lg:h-[30.5rem]">
      <div className="h-[11rem] bg-[#FAFAFA] flex flex-col gap-5 items-center p-[3rem] lg:h-[9rem] lg:flex-row lg:justify-between lg:px-[7rem]">
      ...
      <div className="w-[30rem] h-[67rem] gap-6 grid grid-rows-4 p-[3rem] lg:w-[90rem] lg:h-[17rem] lg:grid-cols-5 lg:mx-auto">
        ...
        <div className=" flex flex-col justify-between gap-4">
          ...
          <div className="border flex">
            <input
              className="w-[25rem] h-[3.5rem] bg-[#F9F9F9] border border-[#E6E6E6] rounded-[0.3rem] leading-[1.75rem] text-sm text-[#737373] pl-[1rem]"
              placeholder="Your Email"
            />
            <button className="w-[7rem] h-[3.5rem] bg-[#23A6F0] border border-[#E6E6E6] rounded-[0.3rem] leading-[1.75rem] text-sm text-white">
              Subscribe
            </button>
          </div>
